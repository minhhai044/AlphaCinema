...
return [
    'exports' => [
        ...
        /**
         * Cấu hình bảng trong database để export
         * 
         * 
         * 'tên bảng'       => [
         *  'model'         => import model cần export,
         *  'columns'       => các trường trong database,
         *  'headings'      => tên cột sau khi export,
         *  'relations'      => tên cột sau khi export,
         *  'image_columns' => chỉ định trường nào là ảnh để export ảnh ra/ để tên cột trong database
         * ]
         * 
         */
        'custom_tables' => [
