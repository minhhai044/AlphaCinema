                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="formatted_discount" class="form-control {{ $errors->has('discount') ? 'is-invalid' : (old('discount') ? 'is-valid' : '') }}" placeholder="Nhập số tiền giảm giá" value="{{ number_format(old('discount', $voucher->discount), 0, '.', ',') }}">

                                <input type="hidden" name="discount" id="discount_hidden" value="{{ old('discount', $voucher->discount) }}">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="quantity" id="quantity" class="form-control" placeholder="Nhập số lượng mã" value="{{ old('quantity', $voucher->quantity) }}">
                                @error('quantity')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="limit_by_user" id="limit_by_user" class="form-control" value="{{ old('limit_by_user', $voucher->limit_by_user) }}" placeholder="Nhập giới hạn sử dụng">
                                @error('limit_by_user')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control" placeholder="Nhập tiêu đề" value="{{ old('title', $voucher->title) }}">
                                @error('title')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" class="form-control" rows="4" placeholder="Nhập mô tả">{{ old('description', $voucher->description) }}</textarea>
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control"
                                        value="{{ old('code', $voucher->code) }}" readonly>
                                    @error('code')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="formatted_discount" class="form-control"
                                ...
                                <div class="mb-3 d-flex gap-2">
                                    ...
                                    <div class="square-switch">
                                        ...
                                        <input type="checkbox" id="square-switch3" switch="bool" value="1"
                                            name="is_active" {{ old('is_active', $voucher->is_active) ? 'checked' : '' }}>
                                        <label for="square-switch3" data-on-label="Yes" data-off-label="No"></label>
                                    </div>
                                </div>
                            </div>
