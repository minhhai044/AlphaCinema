...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Cập nhật Combo: {{ $data->name }}</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <!-- end page title -->
    <form action="{{ route('admin.combos.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-9">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <div class="mb-3">
                                        <label class="form-label" for="price">Giá tiền (VNĐ)</label>
                                        <input
                                            type="text"
                                ...
                                <div>
                                    <div class="mb-3">
                                        <label class="form-label" for="price_sale">Giá Sale (VNĐ)</label>
                                        <input
                                            type="text"
                                            class="form-control {{ $errors->has('price_sale') ? 'is-invalid' : (old('price_sale') ? 'is-valid' : '') }}"
                                            name="price_sale"
                                            id="price_sale"
                                            placeholder="Nhập giá Sale"
                                            value="{{ number_format($data->price_sale) }}">

                                        <div
                                            class="{{ $errors->has('price_sale') ? 'invalid-feedback' : 'valid-feedback' }}">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3 d-flex gap-2">
                                    ...
                                    <div class="square-switch">
                                        <input type="checkbox" id="square-switch3" @checked($data->is_active) switch="bool" value="1"
                                               name="is_active">
                                        <label for="square-switch3" data-on-label="Có" data-off-label="Không"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
