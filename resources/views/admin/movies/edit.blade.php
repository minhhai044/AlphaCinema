                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label">Tên phim <span class="required"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Đường dẫn phim <span class="required"
                                                    style="color: red">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label for="branch_ids" class="form-label">Chi nhánh chiếu phim <span
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Ảnh <span class="required"
                                                    style="color: red">*</span></label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label">Đạo diễn <span class="required"
                                                    style="color: red">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">URL Youtube <span class="required"
                                                    style="color: red">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Thời lượng phim <span class="required"
                                                    style="color: red">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="movie_genres[]" id="movie_genres"
                                                ...
                                                multiple>
                                                <option value="Action" {{ in_array('Action', $selectedGenres) ? 'selected' : '' }}>Hành động
                                                </option>
                                                <option value="Horror" {{ in_array('Horror', $selectedGenres) ? 'selected' : '' }}>Kinh dị
                                                </option>
                                                <option value="Comedy" {{ in_array('Comedy', $selectedGenres) ? 'selected' : '' }}>Hài hước
                                                </option>
                                            </select>
                                            @error('movie_genres')
                                                <div class="text-danger fw-medium">{{ $message }}</div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="movie_versions[]" id="movie_versions"
                                                ...
                                                <option value="IMAX" {{ in_array('IMAX', $selectedVersions) ? 'selected' : '' }}>IMAX
                                                </option>
                                            </select>
                                ...
                                <div class="mb-12">
                                    <label class="form-label">Mô tả <span class="required"
                                            style="color: red">*</span></label>
                                ...
                                @foreach ($statuses as $key => $label)
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        <div class="custom-switch">
                                            <input type="checkbox" id="switch_{{ $key }}" switch="primary" {{ old($key, $movie->$key) ? 'checked' : '' }} />
                                            <label for="switch_{{ $key }}" data-on-label="Yes" data-off-label="No"></label>
                                        </div>
                                        <span>{{ $label }}</span>
                                    </div>
