                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            <label for="regularSeat" class="form-label">Ghế thường <span
                                    style="color: red">*</span></label>
                            <input required type="text" name="row_regular" class="form-control" id="regularSeatCreate"
                                placeholder="Nhập số lượng ghế thường">
                        </div>
                        <div class="col-lg-4 mb-3">
                            <label for="vipSeat" class="form-label">Ghế Vip <span style="color: red">*</span></label>
                            <input required type="text" name="row_vip" class="form-control" id="vipSeatCreate"
                                placeholder="Nhập số lượng ghế Vip">
                        </div>
                        <div class="col-lg-4 mb-3">
                            <label for="doubleSeat" class="form-label">Ghế đôi <span style="color: red">*</span></label>
                            <input required type="text" name="row_double" class="form-control" id="doubleSeatCreate"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            <label for="regularSeat" class="form-label">Ghế thường <span
                                    style="color: red">*</span></label>
                            <input required type="text" name="row_regular" class="form-control" id="regularSeatEdit"
                                placeholder="Nhập số lượng ghế thường">
                        </div>
                        <div class="col-lg-4 mb-3">
                            <label for="vipSeat" class="form-label">Ghế Vip <span style="color: red">*</span></label>
                            <input required type="text" name="row_vip" class="form-control" id="vipSeatEdit"
                                placeholder="Nhập số lượng ghế Vip">
                        </div>
                        <div class="col-lg-4 mb-3">
                            <label for="doubleSeat" class="form-label">Ghế đôi <span style="color: red">*</span></label>
                            <input required type="text" name="row_double" class="form-control" id="doubleSeatEdit"
                                placeholder="Nhập số lượng ghế đôi">
                        </div>
                        <div class="col-lg-12 mb-3">
                            <label for="description" class="form-label">Mô tả</label>
