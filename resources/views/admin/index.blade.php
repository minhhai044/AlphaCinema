                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm align-self-center">
                                <div class="mt-4 mt-sm-0">
                                    ...
                                    <div class="mt-2">
                                        <a href="index.html#" class="btn btn-primary btn-sm">View
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4">
                        <div class="p-4">
                            ...
                            <div class="mt-4 pt-2">
                                <a href="index.html" class="btn btn-primary w-100">See All Balances
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center mb-4">
                    ...
                    <div class="ms-auto">
                        <div class="dropdown">
                            <a class="dropdown-toggle text-reset" href="index.html#" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                <a class="dropdown-item" href="index.html#">USA</a>
                                <a class="dropdown-item" href="index.html#">Russia</a>
                                <a class="dropdown-item" href="index.html#">Australia</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <ul class="nav nav-tabs-custom card-header-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="index.html#buy-tab" role="tab">Buy</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="index.html#sell-tab" role="tab">Sell</a>
                        </li>
                    </ul>
                </div>
            </div><!-- end card header -->
