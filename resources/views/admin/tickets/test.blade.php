                        ...
                        <div class="dropdown d-none d-lg-inline-block ms-1">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                                <div class="p-2">
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="tables-datatable.html#">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                ...
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="tables-datatable.html#!" class="small text-reset text-decoration-underline"> Unread (3)</a>
                                        </div>
                                    </div>
                                </div>
                                <div data-simplebar style="max-height: 230px;">
                                    <a href="tables-datatable.html#!" class="text-reset notification-item">
                                        <div class="d-flex">
                        ...
                        <div class="card sidebar-alert border-0 text-center mx-4 mb-0 mt-5">
                            <div class="card-body">
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="tables-datatable.html#!" class="btn btn-primary mt-2">Upgrade Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Design & Develop by <a href="tables-datatable.html#!" class="text-decoration-underline">Themesbrand</a>
                                </div>
                            </div>
                        </div>
                    </div>
