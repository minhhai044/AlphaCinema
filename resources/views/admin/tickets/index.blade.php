                    ...
                    @forelse ($tickets as $ticket)
                        <tr>
                            ...
                            <td>
                                ...
                                <strong>Chức vụ:</strong><span class="badge bg-success">{{ $ticket->user->role ?? 'member' }}</span><br>
                            ...
                            <td>
                                ...
                                <strong>Nơi chiếu:</strong> {{ $ticket->branch->name ?? 'N/A' }} - {{ $ticket->cinema->name ?? 'N/A' }} <br>
                                <strong>Ghế:</strong>
                                @php
                                ...
                                <strong>Trạng thái:</strong> {{ $ticket->status == 'confirmed' ? 'Đã xác nhận' : 'Chờ xác nhận' }}<br>
                                <strong>Lịch chiếu:</strong> {{ $ticket->showtime->start_time ?? 'N/A' }} - {{ $ticket->showtime->end_time ?? 'N/A' }}<br>
