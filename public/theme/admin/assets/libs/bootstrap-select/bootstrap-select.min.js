    ...
    !(function (T) {
        ...
        function A() {
            var e = this.selectpicker.main.data.filter(function (e) {
                return (
                    !!e.selected && (!this.options.hideDisabled || !e.disabled)
                );
            }, this);
        ...
        function z(e) {
            for (
                ...
                (t = s[n]).disabled ||
                    i.push(void 0 === t.value ? t.text : t.value);
            ...
            Z = {
                ...
                text: function (e, t) {
                    ...
                    if (e.content) n.innerHTML = e.content;
                        ...
                        e.subtext &&
                            (((i = K.subtext.cloneNode(!1)).textContent =
                                e.subtext),
                            n.appendChild(i));
                    }
                    if (!0 === t)
                ...
                label: function (e) {
                    ...
                    return (
                        e.subtext &&
                            (((t = K.subtext.cloneNode(!1)).textContent =
                                e.subtext),
                            s.appendChild(t)),
                        K.fragment.appendChild(s),
                        K.fragment
        ...
        var te = function (e, t) {
            var i = this;
            u.useDefault ||
                ((T.valHooks.select.set = u._set), (u.useDefault = !0)),
                (this.$element = T(e)),
        ...
        function ie(e) {
            ...
            if (([].shift.apply(a), !j.success)) {
                try {
                    ...
                    te.BootstrapVersion
                        ? (j.full =
                              te.BootstrapVersion.split(" ")[0].split("."))
                        : ((j.full = [j.major, "0", "0"]),
                          console.warn(
        ...
        (te.VERSION = "1.14.0-beta2"),
            (te.DEFAULTS = {
                noneSelectedText: "Vui lòng chọn chi nhánh",
            ...
            (te.prototype = {
                ...
                createView: function (z, e, t) {
                    ...
                    function W(e, t) {
                        ...
                        for (var f = 0; f < s; f++) {
                            ...
                            void 0 === l &&
                                e - 1 <=
                                    N.selectpicker.current.data[m - 1]
                                        .position -
                                        N.sizeInfo.menuInnerHeight &&
                                (l = f);
                        }
                        if (
                            ...
                            void 0 !== N.activeIndex &&
                                ((L = (
                                    N.selectpicker.main.data[
                                        N.prevActiveIndex
                                    ] || {}
                                ).element),
                                (H = (
                                    N.selectpicker.main.data[N.activeIndex] ||
                                    {}
                                ).element),
                                (D = (
                                    N.selectpicker.main.data[N.selectedIndex] ||
                                    {}
                                ).element),
                                t &&
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        N.sizeInfo.totalMenuWidth >
                                            N.sizeInfo.selectWidth
                                    )
                                        b.firstChild.style.minWidth =
                                            N.sizeInfo.menuInnerInnerWidth +
                                            "px";
                                    else if (
                                        C > N.sizeInfo.menuInnerInnerWidth
                                    ) {
                            ...
                            ((!z && N.options.source.load) ||
                                ...
                                N.fetchData(
                                    ...
                                    l + 1,
                                    z
                                        ? N.selectpicker.search.previousValue
                                        : void 0
                                );
                        }
                        if (
                            ...
                            if (z && t) {
                                ...
                                N.selectpicker.view.canHighlight[T] ||
                                    (T =
                                        1 +
                                        N.selectpicker.view.canHighlight
                                            .slice(1)
                                            .indexOf(!0)),
                                    (A =
                                        N.selectpicker.view.visibleElements[T]),
                                    N.defocusItem(
                ...
                buildData: function (p, e) {
                    ...
                    "load" === e
                        ...
                        : "search" === e &&
                          (l = this.selectpicker.search.data.length),
                    ...
                    switch (e) {
                        case "data":
                            this.selectpicker.main.data =
                                this.selectpicker.current.data = m;
                            break;
                        case "load":
                ...
                buildList: function (e, t) {
                    ...
                    function l(e, t) {
                        ...
                        (t.element = i),
                            ...
                            o < s &&
                                ((o = s),
                                (n.selectpicker.view.widestOption =
                                    e[e.length - 1]));
                    }
                ...
                render: function (e) {
                    ...
                    if (
                        ...
                        (this.multiple &&
                            ...
                            1 < l &&
                            ((1 <
                                (t = this.options.selectedTextFormat.split(">"))
                                    .length &&
                                l > t[1]) ||
                                (1 === t.length && 2 <= l)))
                    ) {
                        if (!n) {
                            for (var u = 0; u < l && u < 50; u++) {
                                ...
                                f &&
                                    (this.multiple &&
                                        0 < u &&
                                        h.appendChild(d.cloneNode(!1)),
                                    f.title
                                        ? (m.text = f.title)
                                        : f.content && i.options.showContent
                                        ? ((m.content = f.content.toString()),
                                          (p = !0))
                                        : (i.options.showIcon &&
                                              (m.icon = f.icon),
                    ...
                    if (
                        ...
                        var t,
                            ...
                            d =
                                this.options.header &&
                                0 <
                                    this.$menu.find("." + G.POPOVERHEADER)
                                        .length
                                    ? this.$menu
                                          .find("." + G.POPOVERHEADER)[0]
                                          .cloneNode(!0)
                                    : null,
                ...
                setMenuSize: function (e) {
                    ...
                    if (
                        (this.options.dropupAuto &&
                            ((r =
                                d * this.selectpicker.current.data.length +
                                v.vert),
                            (a =
                                this.sizeInfo.selectOffsetTop -
                                    this.sizeInfo.selectOffsetBot >
                ...
                setDisabled: function (e) {
                    ...
                    s &&
                        ...
                        t &&
                            ("4" <= j.major &&
                                t.classList.toggle(G.DISABLED, i),
                            i
                                            ...
                                            (function () {
                                                if (O.multiple) O.deselectAll();
                                                    ...
                                                    n && O.setSelected(n, !1),
                                                        (e.selectedIndex = 0),
                                                        (D = [i, !1, t]),
                                                        O.$element.triggerNative(
                                                            "change"
                                                        );
                                                }
                                                O.$newElement.hasClass(
                                                    G.SHOW
                                                ) &&
                                                    (O.options.liveSearch &&
                                                        O.$searchbox.trigger(
                        ...
                        this.$menuInner.on("click", "li a", function (e, t) {
                            ...
                            if (
                                ...
                                O.options.source.data &&
                                    ...
                                    !O.multiple ||
                                    (O.multiple && 1 === O.options.maxOptions)
                        ...
                        this.$searchbox.on("input propertychange", function () {
                            ...
                            if (
                                ...
                                if (u.options.source.search)
                                    ...
                                    for (
                                        var r = 0;
                                        r < u.selectpicker.main.data.length;
                                        r++
                                    ) {
                ...
                val: function (t) {
                    ...
                    for (var n = 0; n < i.length; n++) {
                        var o = i[n];
                        o &&
                            -1 === t.indexOf(String(o.value)) &&
                            this.setSelected(o, !1);
                    }
                    if (
                ...
                changeAll: function (e) {
                    if (this.multiple) {
                        ...
                        for (
                            var o = 0,
                                l = this.selectpicker.current.data,
                                r = l.length;
                            o < r;
                            o++
                        ) {
                ...
                toggle: function (e, t) {
                    ...
                    (e = e || window.event) && e.stopPropagation(),
                        !1 === s &&
                            ((i = this.$newElement[0].classList.contains(
                                G.SHOW
                            )),
                            (s =
                                (!0 === t && !1 === i) ||
                ...
                keydown: function (e) {
                    var t,
                        ...
                        a = (
                            r ? l.closest(".dropdown") : l.closest(q.MENU)
                        ).data("this"),
                        c = a.findLis(),
                        d = !1,
